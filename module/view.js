let ICON = '<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="red" class="bi bi-x-lg" viewBox="0 0 16 16">\n' +
...
export class View {
    constructor() {
        ...
        this.wrapper.append(this.searchLine);
        this.wrapper.append(this.listAdded);
    ...
    createAutocomplete(repositoryName, counter, owner, star) {
        ...
        if (counter < 5) {
            ...
            repository.addEventListener('click', () => {
                this.createListOfRepository(repository, owner, star);
                this.input.value = '';
                repository.remove();
            })
